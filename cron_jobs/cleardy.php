...
// This block deletes all accounts that do not activate after 10 days
$sql = "SELECT id, username FROM users WHERE signup<=CURRENT_DATE - INTERVAL 10 DAY AND activated='0'";
