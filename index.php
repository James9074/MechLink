...
?>
<?php include_once($_SERVER['DOCUMENT_ROOT']."/includes/joincode.php"); ?>
<!doctype html>
...
<?php include_once($_SERVER['DOCUMENT_ROOT']."/includes/headsc.php") ?>
</head>
  ...
  <div class="gridHeader clearfix">
    <div align="center">
      <div id="content">
        <div id="contentInner">
          <div align="center">
            <div id="contentitem"><a href="#"><img src="images/indexitem.png" /></a></div>
            <div id="contentitem"><a href="#"><img src="images/indexitem.png" /></a></div>
            <div id="contentitem"><a href="#"><img src="images/indexitem.png" /></a></div>
            <div id="contentitem"><a href="#"><img src="images/indexitem.png" /></a></div>
            <div id="contentitem"><a href="#"><img src="images/indexitem.png" /></a></div>
          ...
          <div align="center"><?php echo $userlist; ?></div>
        </div>
        <!--contentinner--> 
